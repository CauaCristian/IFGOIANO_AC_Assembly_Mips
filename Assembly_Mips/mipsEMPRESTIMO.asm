...
.text 
	...
	j final
		maior:
			...
			printString("digite um valor inteiro desejado para o seu emprestimo: ")
			readInt($t1)
			#pegando por quantas vezes o usuario quer pagar o emprestimo
			printString("digite por quantos meses deseja pagar seu emprestimo: ")
			readInt($t2)
			...
			continuar:
				...
				printString("Você está aprovado ")
				printString("durante ")
	...
	final: 
		...
		printString("Você nâo está aprovado")
		#encerrando o codigo
		endCode()
